...
export const mockHotels: Hotel[] = [
  {
    ...
    description:
      "Luxury hotel in the heart of the city with world-class amenities and breathtaking views.",
    description_ar: "فندق فخم في قلب المدينة يوفر وسائل راحة عالمية المستوى وإطلالات خلابة.",
    featured: true,
    deal: true,
    address: "123 Main St, New York, NY 10001",
    address_ar: "123 الشارع الرئيسي، نيويورك",
  },
  {
    id: "2",
    name: "Seaside Resort",
    name_ar: "منتجع سيسايد",
    city: "Miami",
    city_ar: "ميامي",
    country: "USA",
    country_ar: "الولايات المتحدة الأمريكية",
    ...
    description_ar:
      "منتجع جميل مواجه للشاطئ يتميز بإطلالات مذهلة على المحيط وإمكانية الوصول إلى الشاطئ الخاص.",
    featured: true,
    deal: false,
    address: "456 Ocean Blvd, Miami, FL 33101",
    address_ar: "456 بوليفارد المحيط، ميامي",
  },
  {
    id: "3",
    name: "Mountain Lodge",
    ...
    description_ar: "ملاذ جبلي مريح ومثالي لمحبي الطبيعة وعشاق التزلج.",
    featured: false,
    deal: true,
    address: "789 Mountain Rd, Denver, CO 80201",
    address_ar: "789 طريق الجبل، دنفر",
  },
  {
    id: "5",
    name: "Le Meurice",
    ...
    description_ar: "فخامة كلاسيكية وديكور أنيق بالقرب من متحف اللوفر.",
    featured: true,
    deal: false,
    address: "228 Rue de Rivoli, 75001 Paris, France",
    address_ar: "228 شارع ريفولي، باريس",
  },
  {
    id: "6",
    name: "Burj Al Arab",
    ...
    description_ar: "خلاصة الفخامة بتصميمه المميز على شكل شراع.",
    featured: true,
    deal: false,
    address: "Jumeirah St, Umm Suqeim 3, Dubai, UAE",
    address_ar: "شارع جميرا، دبي",
  },
  {
    id: "7",
    name: "Aman Tokyo",
    ...
    description_ar: "ملاذ حضري في قلب طوكيو يتميز بإطلالات بانورامية على المدينة.",
    featured: true,
    deal: true,
    address: "The Otemachi Tower, 1-5-6 Otemachi, Chiyoda-ku, Tokyo",
    address_ar: "برج أوتيماتشي، طوكيو",
  },
  {
    id: "8",
    name: "Katikies Santorini",
    name_ar: "كاتيكيز سانتوريني",
    city: "Santorini",
    city_ar: "سانتوريني",
    country: "Greece",
    country_ar: "اليونان",
    ...
    description_ar: "فندق بوتيك فاخر مطلي باللون الأبيض يطل على بحر إيجه.",
    featured: true,
    deal: true,
    address: "Main Street, Oia 847 02, Greece",
    address_ar: "الشارع الرئيسي، أويا، اليونان",
  },
  {
    id: "9",
    name: "Marriott Mena House",
    name_ar: "فندق ماريوت مينا هاوس",
    city: "Cairo",
    city_ar: "القاهرة",
    country: "Egypt",
    country_ar: "مصر",
    ...
    description_ar: "إطلالات تخطف الأنفاس على الأهرامات من فندق فخم وتاريخي.",
    featured: true,
    deal: false,
    address: "6 Pyramids Road, Giza, Cairo",
    address_ar: "6 شارع الأهرامات، الجيزة، القاهرة",
  },
  {
    id: "10",
    name: "Four Seasons Resort",
    name_ar: "منتجع فور سيزونز",
    ...
    description:
      "A world-class beachfront resort offering incredible diving experiences at the Red Sea.",
    description_ar: "منتجع عالمي على شاطئ البحر يقدم تجارب غوص لا تصدق في البحر الأحمر.",
    featured: true,
    deal: true,
    address: "1 Four Seasons Boulevard, Sharm El Sheikh",
    address_ar: "1 بوليفارد فور سيزونز، شرم الشيخ",
  },
  {
    id: "11",
    name: "Hotel Danieli",
    name_ar: "فندق دانييلي",
    city: "Venice",
    city_ar: "البندقية",
    country: "Italy",
    country_ar: "إيطاليا",
    ...
    description_ar: "فندق فخم تاريخي يقع على بعد خطوات من ساحة القديس مارك.",
    featured: true,
    deal: false,
    address: "Riva degli Schiavoni, Venice",
    address_ar: "ريفا ديلي سكيافوني، البندقية",
  },
  {
    id: "12",
    name: "Rome Cavalieri",
    name_ar: "روما كافالييري",
    city: "Rome",
    city_ar: "روما",
    country: "Italy",
    country_ar: "إيطاليا",
    ...
    description_ar: "منتجع والدورف أستوريا يقدم إطلالات بانورامية على روما.",
    featured: false,
    deal: true,
    address: "Via Alberto Cadlolo, Rome",
    address_ar: "فيا ألبيرتو كادلولو، روما",
  },
  {
    id: "13",
    name: "Ciragan Palace Kempinski",
    name_ar: "قصر جيراغان كمبينسكي",
    city: "Istanbul",
    city_ar: "إسطنبول",
    country: "Turkey",
    country_ar: "تركيا",
    ...
    description_ar: "قصر إمبراطوري عثماني وفندق على مضيق البوسفور.",
    featured: true,
    deal: false,
    address: "Ciragan Caddesi, Besiktas, Istanbul",
    address_ar: "شارع جيراغان، بشكتاش، إسطنبول",
  },
  {
    id: "14",
    name: "Museum Hotel",
    ...
    description_ar: "تجربة فندقية فريدة وفخمة في الكهوف مع إطلالات على المناطيد.",
    featured: true,
    deal: true,
    address: "Tekeli Mah, Uchisar, Cappadocia",
    address_ar: "تيكيلي ماه، أوجيسار، كابادوكيا",
  },
  {
    id: "15",
    name: "Soneva Fushi",
    ...
    description_ar: "منتجع فاخر وحائز على جوائز على جزيرة صحراوية.",
    featured: true,
    deal: false,
    address: "Kunfunadhoo Island, Baa Atoll",
    address_ar: "جزيرة كونفونادو، با اتول",
  },
  {
    id: "16",
    name: "Gili Lankanfushi",
    name_ar: "جيلي لانكانفوشي",
    city: "North Male Atoll",
    city_ar: "ماليه الشمالية اتول",
    country: "Maldives",
    country_ar: "جزر المالديف",
    price: 1100,
    rating: 4.9,
    ...
    description_ar: "فيلات مائية صديقة للبيئة تتمتع بأقصى درجات الخصوصية.",
    featured: false,
    deal: true,
    address: "Lankanfushi Island, North Male Atoll",
    address_ar: "جزيرة لانكانفوشي، ماليه الشمالية",
  },
  {
    id: "17",
    name: "W Barcelona",
    name_ar: "دبليو برشلونة",
    city: "Barcelona",
    city_ar: "برشلونة",
    country: "Spain",
    country_ar: "اسبانيا",
    ...
    description_ar: "فندق مذهل يشبه الشراع مع إطلالات بانورامية على البحر الأبيض المتوسط.",
    featured: true,
    deal: false,
    address: "Placa Rosa dels Vents 1, Barcelona",
    address_ar: "بلاسا روزا ديلس فينتس 1، برشلونة",
  },
  {
    id: "18",
    name: "Hotel Ritz",
    ...
    description_ar: "قصر من حقبة الـ Belle Époque في المثلث الذهبي للفنون.",
    featured: false,
    deal: true,
    address: "Plaza de la Lealtad 5, Madrid",
    address_ar: "ساحة دي لا ليالتاد 5، مدريد",
  },
  {
    id: "19",
    ...
    description_ar: "فندق فخم أسطوري على ضفاف نهر تشاو فرايا.",
    featured: true,
    deal: false,
    address: "48 Oriental Avenue, Bangkok",
    address_ar: "48 أورينتال أفنيو، بانكوك",
  },
  {
    id: "20",
    name: "Keemala",
    ...
    description_ar: "أرض العجائب من الفيلات المزودة بمسابح في غابة كمالا المطيرة.",
    featured: false,
    deal: true,
    address: "10/88 Nakasud Rd, Kamala, Phuket",
    address_ar: "10/88 طريق ناكاسود، بوكيت",
  },
  {
    id: "21",
    name: "The Ritz",
    ...
    description_ar: "فندق فخم ومميز في بيكاديللي يشتهر بشاي بعد الظهر المشهور عالمياً.",
    featured: true,
    deal: false,
    address: "150 Piccadilly, St. James, London",
    address_ar: "150 بيكاديللي، لندن",
  },
  {
    id: "22",
    name: "The Savoy",
    ...
    description_ar: "فندق فخم وشهير يتمتع بموقع مثالي على نهر التايمز.",
    featured: false,
    deal: true,
    address: "Strand, London",
    address_ar: "ستراند، لندن",
  },
  {
    id: "23",
    name: "Atlantis The Palm",
    name_ar: "أتلانتس النخلة",
    city: "Dubai",
    city_ar: "دبي",
    country: "UAE",
    country_ar: "الإمارات العربية المتحدة",
    ...
    description_ar: "منتجع بطابع المحيط يتميز بحديقة مائية ضخمة وأكواريوم.",
    featured: true,
    deal: true,
    address: "Crescent Rd, The Palm Jumeirah, Dubai",
    address_ar: "طريق الهلال، نخلة جميرا، دبي",
  },
  {
    id: "24",
    name: "Hôtel Plaza Athénée",
    name_ar: "فندق بلازا أثيني",
    city: "Paris",
    city_ar: "باريس",
    country: "France",
    country_ar: "فرنسا",
    ...
    description_ar: "عُنوان الأزياء الراقية في باريس مع إطلالات على برج إيفل.",
    featured: true,
    deal: false,
    address: "25 Avenue Montaigne, 75008 Paris",
    address_ar: "25 شارع مونتين، باريس",
  },
  {
    id: "25",
    name: "Park Hyatt",
    ...
    description_ar: "فندق فخم ومميز ظهر في فيلم ضائع في الترجمة.",
    featured: false,
    deal: true,
    address: "3-7-1-2 Nishi-Shinjuku, Tokyo",
    address_ar: "3-7-1-2 نيشي شينجوكو، طوكيو",
  },
  {
    id: "26",
    name: "Cavo Tagoo",
    ...
    description_ar: "فندق أنيق يوفر مسابح لا متناهية وإطلالات خلابة على غروب الشمس.",
    featured: true,
    deal: false,
    address: "Tagoo, Mykonos 846 00, Greece",
    address_ar: "تاجو، ميكونوس، اليونان",
  },
];
